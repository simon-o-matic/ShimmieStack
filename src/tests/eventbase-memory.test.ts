...
describe('Eventbase', () => {
    ...
    describe('When adding an event', () => {
        it('should succeed if a valid object is provided, without a version id',
            async () => {
                await eventBase.addEvent({
                    streamId: 'EXAMPLE_STREAM_1',
                    data: { foo: 'bar' },
        ...
        it('should succeed if provided the most up to date versionId as an input',
            async () => {
        ...
        it('should fail if provided any out of date versionId as an input',
            async () => {
                ...
                try {
                    ...
                    expect(e.details).toEqual(
                        [
                            { 'actualVersionId': 'V2', 'expectedVersionId': 'V1', 'streamId': 'EXAMPLE_STREAM_1',},
                            { 'actualVersionId': 'V2', 'expectedVersionId': 'V1', 'streamId': 'EXAMPLE_STREAM_2' },
                        ],
                    )
                }
            })
