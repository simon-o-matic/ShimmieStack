...
import { CipherCCMTypes, CipherGCMTypes, CipherKey, CipherOCBTypes } from 'crypto'
...
export default function Encryption ({key, encoding='hex', algo='aes-256-cbc'}: EncryptionParams): Cryptor  {
